...
1. In GitHub, navigate to your `eslz` repository and click on the `root/eslz (eslz)` folder folder. 
     
   ![img](images/img1.png)
    
2. Now click on `eslz-landingzones (eslz-landingzones)` folder and navigate to your `eslz-online (eslz-online)` folder which represents the management group for all your online landing zones.

   ![img](images/img2.png)

3. Click on ‘Add file’, and ‘Create new file’.

   ![img](images/img3.png)


4. Name the file ‘locationAssignment.json’

   ![img](images/img4.png)

5.   Copy and paste the following ARM template json
...
6. On the ‘Commit new file’ option, select ‘Create a new branch for this commit and start a pull request’, and give it a name.
   ...
   ![Graphical user interface, text, application, email  Description automatically generated](images/img5.png)
...
7. Click ‘Propose new file' and on the next page, click 'Create Pull Request." A new Pull Request is being created which will trigger the Push workflow. Go to Actions to monitor the process.
   ...
   ![Graphical user interface, text, application, chat or text message  Description automatically generated](images/img6.png)
